        ...
        return (
            <Page name="pertanyaanPengguna" hideBarsOnScroll>
                <Navbar sliding={false} backLink="Kembali" onBackClick={this.backClick}>
                    <NavTitle sliding>Pertanyaan Anda</NavTitle>
                    <NavTitleLarge>
                        Pertanyaan Anda
                    </NavTitleLarge>
                    <NavRight>
                        <Link style={{marginLeft:'0px'}} iconIos="f7:plus_app" iconAurora="f7:plus_app" iconMd="material:plus_app" tooltip="Buat Pertanyaan Baru" href="/tambahPertanyaan">&nbsp; Pertanyaan Baru</Link>
                    </NavRight>
                </Navbar>
