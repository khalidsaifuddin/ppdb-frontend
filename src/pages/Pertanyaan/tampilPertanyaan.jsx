        ...
        return (
            <Page name="tampilPertanyaan" hideBarsOnScroll>
                <Navbar sliding={false} backLink="Kembali" onBackClick={this.backClick}>
                    <NavTitle sliding>Pertanyaan</NavTitle>
                    <NavTitleLarge>
                        Pertanyaan
                    </NavTitleLarge>
                </Navbar>
                                                ...
                                                <CardContent style={{paddingTop:'8px'}}>
                                                    ...
                                                    <Row>
                                                        ...
                                                        <Col width="85" tabletWidth="90">
                                                            <span style={{fontSize:'12px', color: '#8c8c8c'}}>Dijawab pada tanggal <b>{tanggalJawaban}</b></span><br/>
                                                            <span style={{fontSize:'12px', color: '#8c8c8c'}}>Oleh <b>{optionJawaban.pengguna}</b></span>
                                                            <hr style={{borderTop:'1px solid #eeeeee'}}/>
                                                            <div style={{marginTop:'-8px', width:'100%', overflowX:'hidden'}}>
                                                                <div dangerouslySetInnerHTML={{ __html: optionJawaban.konten }} />
                                                            </div>
                                                        </Col>
                                                    </Row>
                                                </CardContent>
                                                                ...
                                                                <Row style={{paddingLeft:'8px', paddingRight:'8px'}}>
                                                                    ...
                                                                    <Col width="85" tabletWidth="90">
                                                                        ...
                                                                        <div style={{width:'100%', overflowX:'hidden'}}>
                                                                            <div dangerouslySetInnerHTML={{ __html: optionKomentar.konten }} />
                                                                        </div>
                                                                    </Col>
                                                                </Row>
                                                                <hr style={{borderTop:'1px solid #eeeeee'}}/>
