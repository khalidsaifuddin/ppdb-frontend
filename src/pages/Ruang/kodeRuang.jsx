                ...
                {this.props.ruang.rows.map((option)=>{
                    return (
                        <>
                            ...
                            <Block strong style={{marginTop:'0px', marginBottom:'8px', textAlign:'center'}}>
                                Silakan bagikan Kode Ruang diatas kepada calon peserta kuis ini
                                <br/>
                                <br/>
                                <Button style={{width:'100px', margin:'auto', background:'#cccccc', color:'#434343'}} raised fill onClick={()=>this.$f7router.navigate('/Ruang/')}>
                                    Tutup
                                </Button>
                            </Block>
                        </>
